...
namespace Iced.Intel.EncoderInternal
{
	...
	{
		public static readonly Op[] LegacyOps = new Op[]
		{
			new OpA(2),
			new OpA(4),
			new OpO(),
		...
		public static readonly Op[] VexOps = new Op[]
		{
			new OpModRM_rm_mem_only(false),
		...
		public static readonly Op[] XopOps = new Op[]
		{
			new OpModRM_rm(Register.EAX, Register.R15D),
			new OpModRM_rm(Register.RAX, Register.R15),
			new OpModRM_rm(Register.XMM0, Register.XMM15),
		...
		public static readonly Op[] EvexOps = new Op[]
		{
			new OpModRM_rm_mem_only(false),
